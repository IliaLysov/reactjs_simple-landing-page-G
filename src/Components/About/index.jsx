...
function About({refLink}) {
    ...
    const images = (
        <div className={styles.images}>
            <Splide>
                <SplideSlide><img src={aboutImg1} alt="about1" className={styles.image}/></SplideSlide>
                <SplideSlide><img src={aboutImg2} alt="about2" className={styles.image}/></SplideSlide>
                <SplideSlide><img src={aboutImg3} alt="about3" className={styles.image}/></SplideSlide>
                <SplideSlide><img src={aboutImg4} alt="about4" className={styles.image}/></SplideSlide>
                <SplideSlide><img src={aboutImg5} alt="about5" className={styles.image}/></SplideSlide>
                <SplideSlide><img src={aboutImg6} alt="about6" className={styles.image}/></SplideSlide>
            </Splide>
        </div>
    )
